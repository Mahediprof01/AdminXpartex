  ...
  if (!order) {
    return (
      <div className="p-8 text-center text-red-500 font-semibold">
        Logistics retail order not found.
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Edit Logistics Retail Order</h1>
          <p className="text-muted-foreground">
            Update the details for this logistics retail order.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg border-0 p-4 md:p-6">
        <Card className="border-0 shadow-none max-w-full">
          <CardHeader>
            <CardTitle>Logistics Retail Order Details</CardTitle>
          </CardHeader>
          <CardContent>
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <Label>Logistics Retail Partner</Label>
                  <Input
