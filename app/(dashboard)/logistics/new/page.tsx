				...
				<CardContent>
					<form className="space-y-4" onSubmit={handleSubmit}>
						...
						<div>
							...
							<Input value={formData.customer} onChange={e => handleChange("customer", e.target.value)} required />
						</div>
						<div>
							<Label>Logistics Partner</Label>
							<Input value={formData.partner} onChange={e => handleChange("partner", e.target.value)} required />
						</div>
						<div>
							<Label>Transaction ID</Label>
							<Input value={formData.transactionId} onChange={e => handleChange("transactionId", e.target.value)} />
						</div>
						<div>
							<Label>Status</Label>
						...
						<div className="flex items-center gap-2">
							<input type="checkbox" checked={formData.completed} onChange={e => handleChange("completed", e.target.checked)} />
