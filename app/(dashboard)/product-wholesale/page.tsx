...
export default function ProductsPage() {
  ...
  const columns: import("@tanstack/react-table").ColumnDef<Product, any>[] = [
    ...
    },
    {
      ...
      cell: ({ row }: { row: Row<Product> }) => (
        <Link
          href={`/product-wholesale/${row.original.id}`}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              ...
              <DropdownMenuItem asChild>
                <Link
                  href={`/product-wholesale/${product.id}`}
              ...
              <DropdownMenuItem asChild>
                <Link
                  href={`/product-wholesale/update/${product.id}`}
                  className="cursor-pointer"
                >
    ...
    >
      ...
      <div className="bg-white rounded-xl shadow-lg border-0 p-4 md:p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold">Wholesale Products</h3>
