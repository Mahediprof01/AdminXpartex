      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuItem asChild>
              <Link
                href={`/return-retail/update/${order.id}`}
                className="cursor-pointer"
              >
...
export default function ReturnRetailPage() {
  return (
    <motion.div
    ...
    >
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-pink-600 to-orange-600 bg-clip-text text-transparent"></h2>
        ...
        >
          <Link href="/return-retail/new">
            <Plus className="mr-2 h-4 w-4" />
            Create Retail Return Order
          </Link>
        </Button>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg border-0 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold">All Retail Return Orders</h3>
