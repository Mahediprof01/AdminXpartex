...
import { MoreHorizontal, Plus, Eye, Edit, Trash, Package, CheckCircle, AlertTriangle } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <Card className="rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500">All Retail products</p>
            </CardContent>
          </Card>
      ...
      <div className="bg-white rounded-xl shadow-lg border-0 p-4 md:p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold">Retail Products</h3>
