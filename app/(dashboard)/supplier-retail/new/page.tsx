    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
            Add New Retail Supplier
          </h1>
          <p className="text-muted-foreground">
            Create a new retail supplier partnership
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg border-0 p-4 md:p-6">
        <Card className="border-0 shadow-none max-w-full">
          <CardHeader>
            <CardTitle>Retail Supplier Information</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-end gap-4 pt-4">
                ...
                >
                  ...
                  {isLoading ? "Creating..." : "Create Retail Supplier"}
                </Button>
                <Button type="button" variant="outline" asChild>
                  <Link href="/supplier-retail">Cancel</Link>
                </Button>
              </div>
            </form>
          </CardContent>
