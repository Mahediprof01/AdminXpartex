        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Create a new wholesale order in your inventory
            </p>
          </div>
        </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-center justify-end gap-4 pt-4">
              <Button
                type="submit"
                disabled={isLoading}
                className="bg-gradient-to-r from-blue-600 to-cyan-600 text-transparent hover:from-blue-600 hover:to-cyan-600 text-white shadow-lg"
              >
                <Save className="mr-2 h-4 w-4" />
                {isLoading ? "Creating..." : "Create Wholesale Order"}
              </Button>
